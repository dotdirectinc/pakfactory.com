 ...
 * current page (no link). Composes the @pakfactory/ui breadcrumb primitive
 * (`text-xs`) with faded medium earlier crumbs, a diagonal Slash separator,
 * and a solid font-medium current page.
 */

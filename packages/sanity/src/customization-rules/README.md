...
| `…/customization-rules/resolve` | `resolveForProduct` — what a product can actually offer once the rules settle |
...
46 tests, no Sanity, no network. They use **Node's built-in runner**, not vitest — vitest

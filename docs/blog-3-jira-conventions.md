...
| [PROD-2244](https://dotdirect.atlassian.net/browse/PROD-2244) | Watermark appearance (hexagon sample)                       | In Progress                                                                                                                  | Hexagon luminance sample: [`watermark-geometry.ts`](../packages/components/src/commons/watermark-geometry.ts) `watermarkHexagonSampleRect`; LQIP + blog/www Sharp paths; opacity remains Studio-owned                                                                                                                                                 |
...
- **Files:** [`watermark-geometry.ts`](../packages/components/src/commons/watermark-geometry.ts), [`watermark-lqip-variant.ts`](../packages/components/src/commons/watermark-lqip-variant.ts), blog/www [`watermark-luma-sample.ts`](../apps/blog/src/lib/watermark-luma-sample.ts). Details: [`apps/blog/memory.md`](../apps/blog/memory.md) § PROD-2244.

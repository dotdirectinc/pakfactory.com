...
- Studio field labels use **Page blocks** (not "Page sections"); Sanity content field names (`pageBuilder`, block `_types`) stay stable — no content migration.

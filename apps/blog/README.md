...
Studio: Blog workspace → **Pages → Homepage** (landing/static lists inside Pages gated until `BLOG_STUDIO_LANDING_PAGES`). Humans: see [`memory.md`](./memory.md) for seed commands when bootstrapping.

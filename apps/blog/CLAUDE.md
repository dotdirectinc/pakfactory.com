...
| `/posts-sitemap/[page].xml`| [`src/app/posts-sitemap/[page]/route.ts`](./src/app/posts-sitemap/%5Bpage%5D/route.ts)       | Paginated posts (200/group) + featured-image sitemap; page 1 also includes `/all`. Canonical `{n}.xml`; bare `{n}` still accepted |
| `/tags-sitemap`            | [`src/app/tags-sitemap/route.ts`](./src/app/tags-sitemap/route.ts)                           | 301 → `/tags-sitemap/1.xml`                                                                                             |
| `/tags-sitemap/[page].xml` | [`src/app/tags-sitemap/[page]/route.ts`](./src/app/tags-sitemap/%5Bpage%5D/route.ts)         | Paginated tags with ≥1 post (200/group). Canonical `{n}.xml`; bare `{n}` still accepted                                 |

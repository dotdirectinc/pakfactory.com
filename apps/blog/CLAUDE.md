...
| `/tags-sitemap-[n].xml`    | [`src/app/tags-sitemap/[page]/route.ts`](./src/app/tags-sitemap/%5Bpage%5D/route.ts)         | Paginated tags with ≥1 post (200/group). Public `-[n].xml` (rewrite) → handler; internal `/tags-sitemap/[n]` still accepted |

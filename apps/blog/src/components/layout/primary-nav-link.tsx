...
export function PrimaryNavLink({
    ...
    if (item.external) {
        // Cross-app links (e.g. Case Studies on the www site under the same
        // domain) render as a plain anchor for a full navigation, but stay in
        // the same tab (no target=_blank).
        return (

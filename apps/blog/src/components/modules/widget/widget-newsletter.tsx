...
/**
 * Newsletter capture widget (PROD-1951, Figma `cta-section-02`). Cream band
 * spans the viewport; content uses the normal outer + inner dieline stack.
 */
export function WidgetNewsletter({ heading, body }: WidgetNewsletterProps) {
  ...
  return (
    <section
      ...
      className="relative left-1/2 w-screen max-w-[100vw] -translate-x-1/2 overflow-x-hidden bg-brand-cream"
    >
      <div className={pageDielineOuterClass()}>
        <div className={pageDielineInnerClass("py-10 sm:py-12")}>
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between lg:gap-16">
            ...
            >
              ...
              <p className="mt-3 text-xs text-muted-foreground">
                By subscribing you agree to receive the packaging digest and
                accept our{" "}
                <Link
                  href="/privacy-policy"

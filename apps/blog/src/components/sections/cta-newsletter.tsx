...
import type { CtaNewsletterSection, SectionProps } from "@/components/sections/registry";
import {
 ...
 */
export function CtaNewsletter({ heading, body }: SectionProps<CtaNewsletterSection>) {

...
import type { SectionProps, TagStripSection } from "@/components/sections/registry";
import { tagHref } from "@/lib/blog-post-url";

/**
 * `tagStrip` page-builder section — a horizontal strip of tag pills linking to
 * their `/tag/{slug}` archives (e.g. "Browse by Industries"). Generic over any
 * tag group.
 */
export function TagStrip({ heading, tags }: SectionProps<TagStripSection>) {

...
import type { CtaRfqSection, SectionProps } from "@/components/sections/registry";
 ...
 */
export function CtaRfq({ heading, body, ctaHref }: SectionProps<CtaRfqSection>) {
  return (
    <section aria-labelledby="cta-rfq-heading">
      <Card className="bg-muted/30 text-center">
        ...
        <CardFooter className="justify-center pt-0">
          <Button asChild>
            <Link href={ctaHref ?? defaultQuoteHref()}>Get a quote</Link>
          </Button>
        </CardFooter>
      </Card>
    </section>

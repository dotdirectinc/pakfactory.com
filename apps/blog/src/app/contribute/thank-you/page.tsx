    ...
    <>
      ...
      <main className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="mx-auto max-w-xl rounded-xl border border-border bg-card p-10 text-center shadow-sm">
          <CircleCheckBig className="mx-auto mb-6 size-14 text-green-600 dark:text-green-500" strokeWidth={1.5} />
          <h2 className="text-2xl font-semibold tracking-tight">Pitch received — thank you</h2>
          <p className="mt-3 text-muted-foreground">
            We read every pitch and reply within 5 business days. Keep an eye on your inbox, and

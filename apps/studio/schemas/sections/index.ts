...
/**
 * Page-builder section schemas. Mirrors apps/blog/src/components/sections/registry.ts.
 */
...
export const homePageBuilderSections = [
  postFeaturedRow,
  postCategoryRow,
  postSpotlightRow,
  tagStrip,
...
export const landingPageBuilderSections = [
  tagStrip,
  ctaNewsletter,
  ctaRfq,
  ctaPillars,
...
export const pageBuilderLanding = defineType({
  ...
  title: 'Page sections (landing)',
  type: 'array',
  of: landingPageBuilderSections.map(({ name }) => defineArrayMember({ type: name })),

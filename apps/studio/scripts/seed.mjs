...
const capabilityCategories = [
  { _id: 'cat-material',   _type: 'customizationCategory', title: 'Material',                  slug: slug('material'),                 description: 'Substrate and raw material capabilities — the physical surface your packaging is built from.', order: 1 },
  { _id: 'cat-finishes',   _type: 'customizationCategory', title: 'Finishes',                  slug: slug('finishes'),                 description: 'Surface treatments applied after printing — laminates, coatings, and foils.', order: 2 },
  { _id: 'cat-printing',   _type: 'customizationCategory', title: 'Printing',                  slug: slug('printing'),                 description: 'Ink-on-substrate processes — offset, digital, flexography, and screen.', order: 3 },
  { _id: 'cat-add-custom', _type: 'customizationCategory', title: 'Additional Customization',  slug: slug('additional-customization'), description: 'Structural and decorative add-ons — embossing, die-cutting, inserts, and closures.', order: 4 },
  { _id: 'cat-cert',       _type: 'customizationCategory', title: 'Certifications',            slug: slug('certifications'),           description: 'Environmental and food-safety certifications applicable to PakFactory materials.', order: 5 },
]

const capabilityTypes = [
  // Material
  { _id: 'type-paperboard',   _type: 'customizationType', title: 'Paperboard',         slug: slug('paperboard'),         category: ref('cat-material'),   description: 'Clay-coated and uncoated paperboard grades — the primary substrate for folding carton boxes.', order: 1 },
  { _id: 'type-corrugated',   _type: 'customizationType', title: 'Corrugated',          slug: slug('corrugated'),         category: ref('cat-material'),   description: 'Fluted corrugated board for shipping and e-commerce applications.', order: 2 },
  { _id: 'type-kraft',        _type: 'customizationType', title: 'Kraft Paper',         slug: slug('kraft-paper'),        category: ref('cat-material'),   description: 'Natural unbleached kraft paper — earthy aesthetics, strong structural integrity.', order: 3 },
  { _id: 'type-flexible',     _type: 'customizationType', title: 'Flexible Film',       slug: slug('flexible-film'),      category: ref('cat-material'),   description: 'Multi-layer flexible film laminates for pouches and wraps.', order: 4 },
  // Finishes
  { _id: 'type-lamination',   _type: 'customizationType', title: 'Lamination',          slug: slug('lamination'),         category: ref('cat-finishes'),   description: 'Film bonded to the printed surface — matte, gloss, and soft-touch variants.', order: 1 },
  { _id: 'type-coating',      _type: 'customizationType', title: 'Coating',             slug: slug('coating'),            category: ref('cat-finishes'),   description: 'Liquid applied coatings — aqueous, UV, and spot UV.', order: 2 },
  { _id: 'type-foiling',      _type: 'customizationType', title: 'Foiling',             slug: slug('foiling'),            category: ref('cat-finishes'),   description: 'Metallic or holographic foil stamped or transferred onto the substrate.', order: 3 },
  // Printing
  { _id: 'type-offset',       _type: 'customizationType', title: 'Offset Printing',     slug: slug('offset-printing'),    category: ref('cat-printing'),   description: 'High-fidelity CMYK+PMS lithographic printing — best for mid-to-large runs.', order: 1 },
  { _id: 'type-digital',      _type: 'customizationType', title: 'Digital Printing',    slug: slug('digital-printing'),   category: ref('cat-printing'),   description: 'Variable data, short runs, and prototyping without plates.', order: 2 },
  { _id: 'type-flexo',        _type: 'customizationType', title: 'Flexography',         slug: slug('flexography'),        category: ref('cat-printing'),   description: 'Rotary relief printing on corrugated and flexible substrates.', order: 3 },
  // Additional Customization
  { _id: 'type-embossing',    _type: 'customizationType', title: 'Embossing & Debossing', slug: slug('embossing-debossing'), category: ref('cat-add-custom'), description: 'Raised or recessed relief patterns for tactile brand expression.', order: 1 },
  { _id: 'type-die-cut',      _type: 'customizationType', title: 'Die Cutting',         slug: slug('die-cutting'),        category: ref('cat-add-custom'), description: 'Custom shapes, windows, and structural cutouts.', order: 2 },
  { _id: 'type-window',       _type: 'customizationType', title: 'Window Patching',     slug: slug('window-patching'),    category: ref('cat-add-custom'), description: 'Clear or frosted film adhered behind a die-cut window.', order: 3 },
  // Certifications
  { _id: 'type-fsc',          _type: 'customizationType', title: 'FSC',                 slug: slug('fsc'),                category: ref('cat-cert'),       description: 'Forest Stewardship Council chain-of-custody certification.', order: 1 },
  { _id: 'type-recyclable',   _type: 'customizationType', title: 'Recyclable',          slug: slug('recyclable'),         category: ref('cat-cert'),       description: 'Materials certified as curbside recyclable in North America.', order: 2 },
]

const attributeGroups = [
  { _id: 'ag-source',      _type: 'property', title: 'Source',             slug: slug('source'),             description: 'Fiber origin and raw material sourcing.',         order: 1 },
  { _id: 'ag-physical',    _type: 'property', title: 'Physical Properties',slug: slug('physical-properties'),description: 'Tactile and structural material properties.',       order: 2 },
  { _id: 'ag-performance', _type: 'property', title: 'Performance',         slug: slug('performance'),        description: 'Functional performance characteristics.',          order: 3 },
  { _id: 'ag-aesthetic',   _type: 'property', title: 'Aesthetic',           slug: slug('aesthetic'),          description: 'Visual appearance and finish quality.',            order: 4 },
  { _id: 'ag-color',       _type: 'property', title: 'Color',               slug: slug('color'),              description: 'Available base color options for this material.',  order: 5 },
  { _id: 'ag-opacity',     _type: 'property', title: 'Opacity',             slug: slug('opacity'),            description: 'Light transmission characteristics.',              order: 6 },
  { _id: 'ag-sustain',     _type: 'property', title: 'Sustainability',       slug: slug('sustainability'),     description: 'Environmental and recyclability attributes.',       order: 7 },
  { _id: 'ag-role',        _type: 'property', title: 'Role',                slug: slug('role'),               description: 'Layer role in multi-layer flexible structures.',   order: 8 },
  { _id: 'ag-finish',      _type: 'property', title: 'Finish Type',         slug: slug('finish-type'),        description: 'Surface finish classification.',                   order: 9 },
]

const attributes = [
  // Source
  { _id: 'attr-virgin',        _type: 'propertyValue', title: 'Virgin Fiber',        slug: slug('virgin-fiber'),        property: ref('ag-source'),   order: 1 },
  { _id: 'attr-recycled',      _type: 'propertyValue', title: 'Recycled Fiber',      slug: slug('recycled-fiber'),      property: ref('ag-source'),   order: 2 },
  { _id: 'attr-mixed',         _type: 'propertyValue', title: 'Mixed Fiber',         slug: slug('mixed-fiber'),         property: ref('ag-source'),   order: 3 },
  // Physical Properties
  { _id: 'attr-coated',        _type: 'propertyValue', title: 'Coated',              slug: slug('coated'),              property: ref('ag-physical'), order: 1 },
  { _id: 'attr-uncoated',      _type: 'propertyValue', title: 'Uncoated',            slug: slug('uncoated'),            property: ref('ag-physical'), order: 2 },
  { _id: 'attr-smooth',        _type: 'propertyValue', title: 'Smooth',              slug: slug('smooth'),              property: ref('ag-physical'), order: 3 },
  { _id: 'attr-textured',      _type: 'propertyValue', title: 'Textured',            slug: slug('textured'),            property: ref('ag-physical'), order: 4 },
  { _id: 'attr-printable',     _type: 'propertyValue', title: 'Printable',           slug: slug('printable'),           property: ref('ag-physical'), order: 5 },
  // Performance
  { _id: 'attr-moisture',      _type: 'propertyValue', title: 'Moisture Resistant',  slug: slug('moisture-resistant'),  property: ref('ag-performance'), order: 1 },
  { _id: 'attr-tear',          _type: 'propertyValue', title: 'Tear Resistant',      slug: slug('tear-resistant'),      property: ref('ag-performance'), order: 2 },
  { _id: 'attr-food-safe',     _type: 'propertyValue', title: 'Food Safe',           slug: slug('food-safe'),           property: ref('ag-performance'), order: 3 },
  { _id: 'attr-grease',        _type: 'propertyValue', title: 'Grease Resistant',    slug: slug('grease-resistant'),    property: ref('ag-performance'), order: 4 },
  // Aesthetic
  { _id: 'attr-premium',       _type: 'propertyValue', title: 'Premium Look',        slug: slug('premium-look'),        property: ref('ag-aesthetic'), order: 1 },
  { _id: 'attr-natural',       _type: 'propertyValue', title: 'Natural Look',        slug: slug('natural-look'),        property: ref('ag-aesthetic'), order: 2 },
  { _id: 'attr-bright-white',  _type: 'propertyValue', title: 'Bright White',        slug: slug('bright-white'),        property: ref('ag-aesthetic'), order: 3 },
  // Color
  { _id: 'attr-col-white',     _type: 'propertyValue', title: 'White',               slug: slug('color-white'),         property: ref('ag-color'),    order: 1 },
  { _id: 'attr-col-brown',     _type: 'propertyValue', title: 'Natural Brown',        slug: slug('color-brown'),         property: ref('ag-color'),    order: 2 },
  { _id: 'attr-col-black',     _type: 'propertyValue', title: 'Black',               slug: slug('color-black'),         property: ref('ag-color'),    order: 3 },
  // Opacity
  { _id: 'attr-opaque',        _type: 'propertyValue', title: 'Opaque',              slug: slug('opaque'),              property: ref('ag-opacity'),  order: 1 },
  { _id: 'attr-translucent',   _type: 'propertyValue', title: 'Translucent',         slug: slug('translucent'),         property: ref('ag-opacity'),  order: 2 },
  { _id: 'attr-transparent',   _type: 'propertyValue', title: 'Transparent',         slug: slug('transparent'),         property: ref('ag-opacity'),  order: 3 },
  // Sustainability
  { _id: 'attr-recyclable',    _type: 'propertyValue', title: 'Recyclable',          slug: slug('recyclable'),          property: ref('ag-sustain'),  order: 1 },
  { _id: 'attr-biodegradable', _type: 'propertyValue', title: 'Biodegradable',       slug: slug('biodegradable'),       property: ref('ag-sustain'),  order: 2 },
  { _id: 'attr-compostable',   _type: 'propertyValue', title: 'Compostable',         slug: slug('compostable'),         property: ref('ag-sustain'),  order: 3 },
  { _id: 'attr-fsc',           _type: 'propertyValue', title: 'FSC Certified',       slug: slug('fsc-certified'),       property: ref('ag-sustain'),  order: 4 },
  { _id: 'attr-recycled-cont', _type: 'propertyValue', title: 'Recycled Content',    slug: slug('recycled-content'),    property: ref('ag-sustain'),  order: 5 },
  // Role
  { _id: 'attr-outer',         _type: 'propertyValue', title: 'Outer Layer',         slug: slug('outer-layer'),         property: ref('ag-role'),     order: 1 },
  { _id: 'attr-barrier',       _type: 'propertyValue', title: 'Barrier Layer',       slug: slug('barrier-layer'),       property: ref('ag-role'),     order: 2 },
  { _id: 'attr-sealant',       _type: 'propertyValue', title: 'Sealant Layer',       slug: slug('sealant-layer'),       property: ref('ag-role'),     order: 3 },
  // Finish Type
  { _id: 'attr-ft-matte',      _type: 'propertyValue', title: 'Matte',               slug: slug('finish-matte'),        property: ref('ag-finish'),   order: 1 },
  { _id: 'attr-ft-gloss',      _type: 'propertyValue', title: 'Gloss',               slug: slug('finish-gloss'),        property: ref('ag-finish'),   order: 2 },
  { _id: 'attr-ft-soft',       _type: 'propertyValue', title: 'Soft Touch',          slug: slug('finish-soft-touch'),   property: ref('ag-finish'),   order: 3 },
]

const capabilities = [
  {
    _id: 'cap-sbs', _type: 'customizationOption',
  ...
  {
    _id: 'cap-fbb', _type: 'customizationOption',
  ...
  {
    _id: 'cap-ccnb', _type: 'customizationOption',
  ...
  {
    _id: 'cap-kraft-pb', _type: 'customizationOption',
  ...
  {
    _id: 'cap-gloss-lam', _type: 'customizationOption',
  ...
  {
    _id: 'cap-matte-lam', _type: 'customizationOption',
  ...
  {
    _id: 'cap-soft-touch', _type: 'customizationOption',
  ...
  {
    _id: 'cap-aqueous', _type: 'customizationOption',
...
const productCategories = [
  { _id: 'pc-folding-carton', _type: 'productLine', title: 'Folding Carton Boxes',   slug: slug('folding-carton-boxes'),   description: 'Die-cut and scored paperboard boxes assembled without adhesive. The most common retail packaging format.', order: 1 },
  { _id: 'pc-rigid',          _type: 'productLine', title: 'Rigid Boxes',             slug: slug('rigid-boxes'),            description: 'Thick greyboard boxes with wrapped paper — premium unboxing format for luxury goods.', order: 2 },
  { _id: 'pc-mailer',         _type: 'productLine', title: 'Mailer Boxes',            slug: slug('mailer-boxes'),           description: 'Self-locking corrugated or paperboard boxes designed for e-commerce direct-to-consumer shipping.', order: 3 },
  { _id: 'pc-flexible',       _type: 'productLine', title: 'Flexible Packaging',      slug: slug('flexible-packaging'),     description: 'Pouches, bags, and wraps made from multi-layer flexible film laminates.', order: 4 },
  { _id: 'pc-corrugated',     _type: 'productLine', title: 'Corrugated Shipping',     slug: slug('corrugated-shipping'),    description: 'B-flute and E-flute corrugated boxes for outer shipping cartons and heavy-duty protection.', order: 5 },
]

const productStyleCategories = [
  // Folding Carton
  { _id: 'psc-ste',  _type: 'productStyle', title: 'Straight Tuck End',     slug: slug('straight-tuck-end'),    productLine: ref('pc-folding-carton'), description: 'Both tuck flaps fold in the same direction — front closes at top, back at bottom.', order: 1 },
  { _id: 'psc-rte',  _type: 'productStyle', title: 'Reverse Tuck End',      slug: slug('reverse-tuck-end'),     productLine: ref('pc-folding-carton'), description: 'Tuck flaps fold in opposite directions — front closes at top, back at top.', order: 2 },
  { _id: 'psc-auto', _type: 'productStyle', title: 'Auto Bottom (123)',      slug: slug('auto-bottom'),          productLine: ref('pc-folding-carton'), description: 'Pre-glued base that auto-locks on opening — faster assembly, stronger base.', order: 3 },
  // Rigid
  { _id: 'psc-mag',  _type: 'productStyle', title: 'Magnetic Closure',      slug: slug('magnetic-closure'),     productLine: ref('pc-rigid'),         description: 'Hinged lid held shut by embedded magnets — signature luxury unboxing format.', order: 1 },
  { _id: 'psc-neck', _type: 'productStyle', title: 'Neck Box',              slug: slug('neck-box'),             productLine: ref('pc-rigid'),         description: 'Two-piece box with a raised inner tray (neck) that slides into the outer shell.', order: 2 },
  { _id: 'psc-tele', _type: 'productStyle', title: 'Telescoping Box',       slug: slug('telescoping-box'),      productLine: ref('pc-rigid'),         description: 'Deep lid slides over a deep base — equal-depth two-piece construction.', order: 3 },
  // Mailer
  { _id: 'psc-rsc',  _type: 'productStyle', title: 'Regular Slotted Container', slug: slug('regular-slotted-container'), productLine: ref('pc-mailer'), description: 'Standard corrugated shipper with four equal flaps meeting at center.', order: 1 },
  { _id: 'psc-snap', _type: 'productStyle', title: 'Snap-Lock Mailer',      slug: slug('snap-lock-mailer'),     productLine: ref('pc-mailer'),        description: 'Tool-free self-locking base with hinged lid — optimized for e-commerce.', order: 2 },
]
...
const products = [
  {
    ...
    status: 'active',
    kind: 'standard',
    productLine: ref('pc-folding-carton'),
    productStyle: [ref('psc-ste')],
  ...
  },
  {
    ...
    status: 'active',
    kind: 'both',
    productLine: ref('pc-rigid'),
    productStyle: [ref('psc-mag')],
    capabilitiesOverride: [],
  ...
  },
  {
    ...
    status: 'active',
    kind: 'both',
    productLine: ref('pc-mailer'),
    productStyle: [ref('psc-snap')],
    capabilitiesOverride: [],

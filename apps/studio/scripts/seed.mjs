...
const authors = [
  {
    ...
    credentials: [block('12 years in structural packaging engineering. Certified Packaging Professional (CPP), IoPP. Previous roles: Packaging Development Manager at Unilever Canada; Senior Designer at SGK. Published in Packaging Digest and Pack Expo technical proceedings.')],
    linkedIn: 'https://linkedin.com/in/sarah-chen-packaging',
    relatedCapabilities: [ref('cap-sbs'), ref('cap-fbb'), ref('cap-ccnb'), ref('cap-kraft-pb')],
  ...
  },
  {
    ...
    credentials: [block('MSc Environmental Management, UBC. 8 years in sustainable packaging strategy. Certified Lifecycle Assessment Practitioner (LCA Practitioner). Speaker at Sustainable Packaging Coalition annual conference (2023, 2024, 2025). Regular contributor to GreenBiz and Packaging World.')],
    linkedIn: 'https://linkedin.com/in/marcus-wright-sustainability',
    relatedCapabilities: [ref('cap-gloss-lam'), ref('cap-matte-lam'), ref('cap-aqueous')],
  ...
  },
  {
    ...
    credentials: [block('BFA Industrial Design, OCAD University. 9 years in brand and packaging strategy, including 4 years at Glossier as Packaging Creative Director. Expert in luxury rigid box design, DTC unboxing strategy, and brand-to-shelf translation. Featured in Fast Company, Dieline, and The Dieline Awards jury (2025).')],
    linkedIn: 'https://linkedin.com/in/priya-nair-packaging',
    xHandle: 'priya_pakfactory',
    relatedCapabilities: [ref('cap-soft-touch'), ref('cap-matte-lam'), ref('cap-gloss-lam')],
...
const posts = [
  ...
  },
  {
    ...
    relatedProducts: [ref('prod-ste-001'), ref('prod-mag-001'), ref('prod-snap-001')],
  ...
  },
  {
    ...
    relatedCapabilities: [ref('cap-gloss-lam'), ref('cap-matte-lam'), ref('cap-soft-touch')],

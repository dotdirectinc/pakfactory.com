 ...
 * client navigations only (not the initial page load), including
 * /case-studies. GTM already records the landing pageview on container load;
 * firing here too would double-count. Marketing owns the GTM Custom Event
 * trigger for pageview-scoped tags.
 *

...
export function CatalogFacetGroup({
    title,
    options,
    selected,
    counts,
...
type CatalogFacetGroupSkeletonProps = {
    /** Placeholder checkbox rows under the title. */
    rowCount?: number;
};

/** Loading placeholder matching {@link CatalogFacetGroup} rhythm. */
export function CatalogFacetGroupSkeleton({
    rowCount = 4,
}: CatalogFacetGroupSkeletonProps) {
    return (

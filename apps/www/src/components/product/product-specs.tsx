    ...
    return (
        <section id="pdp-specs" className={cn('scroll-mt-20', className)}>
            <PageDielineSection innerClassName="border-b border-dashed border-border pt-16 pb-0 sm:pt-20">
                ...
                <div className="-mx-12 mt-16 sm:-mx-16">
                            ...
                            {rows.map((row) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center gap-4 py-5 pl-12 pr-6 sm:py-6 sm:pl-16 lg:py-6">
                                                <span
                                                    aria-hidden
                                        ...
                                        <td className="block w-full bg-muted/50 p-0 sm:table-cell sm:align-middle">
                                            <p className="flex min-h-10 items-center pl-6 pr-12 py-5 text-sm leading-none text-foreground sm:min-h-11 sm:pl-8 sm:pr-16 sm:py-6 lg:text-base">
                                                {row.value}
                                            </p>
                                        </td>
                                    </tr>

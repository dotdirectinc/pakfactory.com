export const REQUEST_COPY = {
    ...
    productsSubtitle: 'Add what you want quoted, with quantity and size.',
    productsRailSubtitle: 'Quantity & size',
    servicesTitle: 'Services',
    servicesSubtitle: 'Optional extras',
    servicesRailSubtitle: 'Optional extras',
    servicesHeading: 'Services',
    servicesDesc: 'Add any extras you might want. No commitment.',
    servicesUpsellTitle: 'Add additional services to your project',
    servicesUpsellSupporting: 'Design, dielines, sourcing, fulfilment',
    requirementsTitle: 'Your Requirements',
    requirementsSubtitle: 'Tell us what you need and when you need it.',
    requirementsRailSubtitle: 'Brief & shipping',
    yourInformationTitle: 'Your Information',
    yourInformationSubtitle: 'Confirm the contact details from your account.',
    yourInformationRailSubtitle: 'Contact',
    reviewTitle: 'Review your request',
    reviewSubtitle:
        'One last look — then a specialist will quote pricing, lead time, and next steps.',
    reviewRailSubtitle: 'Review & submit',
    ...
    removeLine: 'Remove',
    removeLineConfirmTitle: 'Remove this product?',
    removeLineConfirmDescription:
        'You’re going to remove “{title}” from your request.',
    removeLineConfirmCancel: 'No, keep it.',
    removeLineConfirmAction: 'Yes, remove!',

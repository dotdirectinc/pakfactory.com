...
| Verify | `pnpm build:blog`, curl `http://localhost:3004/` and `/unknown-slug` |
...
Local verify: `http://localhost:3004` — env/seed troubleshooting in [`apps/blog/memory.md`](../../../apps/blog/memory.md) § Local dev.
